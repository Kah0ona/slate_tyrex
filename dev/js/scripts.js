$("header #menu-item-425 a").prepend('<div></div><svg class="icon icon-banden" viewBox="0 0 31 32"><use xlink:href="#icon-banden"></use></svg>');
$("header #menu-item-423 a").prepend('<div></div><svg class="icon icon-carwash" viewBox="0 0 31 32"><use xlink:href="#icon-carwash"></use></svg>');
$("header #menu-item-422 a").prepend('<div></div><svg class="icon icon-service" viewBox="0 0 31 32"><use xlink:href="#icon-service"></use></svg>');
$("header #menu-item-424 a").prepend('<div></div><svg class="icon icon-velgen2" viewBox="0 0 31 32"><use xlink:href="#icon-velgen2"></use></svg>');
...
$("header #menu-item-429 a").prepend('<svg class="icon icon-mail" viewBox="0 0 31 32"><use xlink:href="#icon-mail"></use></svg>');
